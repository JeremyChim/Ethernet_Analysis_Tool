...
#### 新增
- 新增信号：271、5B8
- flier.py 新增271信号配置：log_271()
- flier.py 新增5B8信号配置：log_5B8()
- 新增白天模式按钮：☀
- 新增夜间模式按钮：☾
#### 修改
- 修改17F的信号名：第二个 INS_Vehicle_Height_Confidence 改成 INS_GNSS_Mode
#### 优化
...
2023.8.7
#### 新增
- 新增udp17F_v18.py：用于解析v1.8协议的17F信号
- 新增udp17F_v19.py：用于解析v1.9协议的17F信号（新增四个轮速的信号）
- 新增udp17F_v20.py：用于解析v2.0协议的17F信号（新增挡位、档位有效位的信号）
- 新增了threading多线程技术，防止在解析大量数据时，UI窗口假死
#### 修改
- 重做了flier.py中的过滤函数
- win.py中新增一栏协议栏：取消了17F多个按钮的显示
#### 注意
- v1.8协议是指《SDA INS 以太网通讯协议格式参考_V1.8_0320.xlsx》
- v1.9协议是指《SDA INS 以太网通讯协议格式参考_V1.9_0626.xlsx》
- v2.0协议是指《SDA INS 以太网通讯协议格式参考_V2.0_0807.xlsx》
